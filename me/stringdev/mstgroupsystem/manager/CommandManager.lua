class 'CommandManager' {
    loadCommands = function (self)
        ...
        for _, nod in ipairs(Meta:getChildren()) do
            ...
            if (srcAttribute and srcAttribute:find("me/stringdev/mstgroupsystem/commands")) then
                local commandObject = srcAttribute:gsub("me/stringdev/mstgroupsystem/commands/", ""):gsub(".lua", "")
