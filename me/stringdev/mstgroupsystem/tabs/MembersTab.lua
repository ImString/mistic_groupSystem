...
function onRenderMember()
    ...
    if (getGroupPlayer():isSuperior()) then
        ...
        dxDrawImage(1161, 267, 17, 14, newUserIcon, 0, 0, 0, tocolor(255, 255, 255, contentAlpha), false)
    ...
    if (action["State"] == "AddUser") then
        ...
        dxDrawImage(893, 454, 33, 33, addUserIcon, 0, 0, 0, tocolor(255, 255, 255, actionAlpha), false)
